 ...
 * @author fefoss454
 */
public class RestaurantsCityOneController implements Initializable {
    ...
    private void setPlaces() throws SQLException {
        ...
        place = dc.getPlaces(43);
        image = dc.getImage(43, "Places");
        placeOneTitle.setText(place);
        placeOneImg.setImage(image);

        place = dc.getPlaces(44);
        image = dc.getImage(44, "Places");
        placeTwoTitle.setText(place);
        placeTwoImg.setImage(image);

        place = dc.getPlaces(45);
        image = dc.getImage(45, "Places");
        placeThreeTitle.setText(place);
        placeThreeImg.setImage(image);

        place = dc.getPlaces(46);
        image = dc.getImage(46, "Places");
        placeFourTitle.setText(place);
        placeFourImg.setImage(image);

        place = dc.getPlaces(47);
        image = dc.getImage(47, "Places");
        placeFiveTitle.setText(place);
        placeFiveImg.setImage(image);

        place = dc.getPlaces(48);
        image = dc.getImage(48, "Places");
