 ...
 * @author fefoss454
 */
public class HotelsCityTwoController implements Initializable {
    ...
    private void showPlaceInfo(ActionEvent event) throws SQLException {
        ...
        if (event.getTarget().equals(placeOneInfo)) {
            ...
            info = dc.getPlaceInfo(25);
            image = dc.getImage(25, "Places");
            ...
            info = dc.getPlaceInfo(26);
            image = dc.getImage(26, "Places");
            placeTitle.setText(info[0]);
            placeDesc.setText(info[1]);
            placeImg.setImage(image);
            ...
            info = dc.getPlaceInfo(27);
            image = dc.getImage(27, "Places");
            placeTitle.setText(info[0]);
            placeDesc.setText(info[1]);
            placeImg.setImage(image);
            ...
            info = dc.getPlaceInfo(28);
            image = dc.getImage(28, "Places");
            placeTitle.setText(info[0]);
            placeDesc.setText(info[1]);
            placeImg.setImage(image);
            ...
            info = dc.getPlaceInfo(29);
            image = dc.getImage(29, "Places");
            placeTitle.setText(info[0]);
            placeDesc.setText(info[1]);
            placeImg.setImage(image);
            ...
            info = dc.getPlaceInfo(30);
            image = dc.getImage(30, "Places");
            placeTitle.setText(info[0]);
            placeDesc.setText(info[1]);
            placeImg.setImage(image);
        }
