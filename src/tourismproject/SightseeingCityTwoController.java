 ...
 * @author fefoss454
 */
public class SightseeingCityTwoController implements Initializable {
    ...
    private void showPlaceInfo(ActionEvent event) throws SQLException {
        ...
        if (event.getTarget().equals(placeOneInfo)) {
            ...
            info = dc.getPlaceInfo(1);
            image = dc.getImage(1, "Places");
            ...
            info = dc.getPlaceInfo(2);
            image = dc.getImage(2, "Places");
            placeTitle.setText(info[0]);
            placeDesc.setText(info[1]);
            placeImg.setImage(image);
            ...
            info = dc.getPlaceInfo(3);
            image = dc.getImage(3, "Places");
            placeTitle.setText(info[0]);
            placeDesc.setText(info[1]);
            placeImg.setImage(image);
            ...
            info = dc.getPlaceInfo(4);
            image = dc.getImage(4, "Places");
            placeTitle.setText(info[0]);
            placeDesc.setText(info[1]);
            placeImg.setImage(image);
            ...
            info = dc.getPlaceInfo(5);
            image = dc.getImage(5, "Places");
            placeTitle.setText(info[0]);
            placeDesc.setText(info[1]);
            placeImg.setImage(image);
            ...
            info = dc.getPlaceInfo(6);
            image = dc.getImage(6, "Places");
            placeTitle.setText(info[0]);
            placeDesc.setText(info[1]);
            placeImg.setImage(image);
        }
