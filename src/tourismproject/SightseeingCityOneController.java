 ...
 * @author fefoss454
 */
public class SightseeingCityOneController implements Initializable {
    ...
    private void setPlaces() throws SQLException {
        ...
        place = dc.getPlaces(7);
        image = dc.getImage(7, "Places");
        placeOneTitle.setText(place);
        placeOneImg.setImage(image);

        place = dc.getPlaces(8);
        image = dc.getImage(8, "Places");
        placeTwoTitle.setText(place);
        placeTwoImg.setImage(image);

        place = dc.getPlaces(9);
        image = dc.getImage(9, "Places");
        placeThreeTitle.setText(place);
        placeThreeImg.setImage(image);

        place = dc.getPlaces(10);
        image = dc.getImage(10, "Places");
        placeFourTitle.setText(place);
        placeFourImg.setImage(image);

        place = dc.getPlaces(11);
        image = dc.getImage(11, "Places");
        placeFiveTitle.setText(place);
        placeFiveImg.setImage(image);

        place = dc.getPlaces(12);
        image = dc.getImage(12, "Places");
