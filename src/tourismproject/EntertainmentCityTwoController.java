 ...
 * @author fefoss454
 */
public class EntertainmentCityTwoController implements Initializable {
    ...
    private void showPlaceInfo(ActionEvent event) throws SQLException {
        ...
        if (event.getTarget().equals(placeOneInfo)) {
            ...
            info = dc.getPlaceInfo(13);
            image = dc.getImage(13, "Places");
            ...
            info = dc.getPlaceInfo(14);
            image = dc.getImage(14, "Places");
            placeTitle.setText(info[0]);
            placeDesc.setText(info[1]);
            placeImg.setImage(image);
            ...
            info = dc.getPlaceInfo(15);
            image = dc.getImage(15, "Places");
            placeTitle.setText(info[0]);
            placeDesc.setText(info[1]);
            placeImg.setImage(image);
            ...
            info = dc.getPlaceInfo(16);
            image = dc.getImage(16, "Places");
            placeTitle.setText(info[0]);
            placeDesc.setText(info[1]);
            placeImg.setImage(image);
            ...
            info = dc.getPlaceInfo(17);
            image = dc.getImage(17, "Places");
            placeTitle.setText(info[0]);
            placeDesc.setText(info[1]);
            placeImg.setImage(image);
            ...
            info = dc.getPlaceInfo(18);
            image = dc.getImage(18, "Places");
            placeTitle.setText(info[0]);
            placeDesc.setText(info[1]);
            placeImg.setImage(image);
        }
