 ...
 * @author fefoss454
 */
public class EntertainmentCityOneController implements Initializable {
    ...
    private void showPlaceInfo(ActionEvent event) throws SQLException {
        ...
        if (event.getTarget().equals(placeOneInfo)) {
            ...
            info = dc.getPlaceInfo(19);
            image = dc.getImage(19, "Places");
            ...
            info = dc.getPlaceInfo(20);
            image = dc.getImage(20, "Places");
            placeTitle.setText(info[0]);
            placeDesc.setText(info[1]);
            placeImg.setImage(image);
            ...
            info = dc.getPlaceInfo(21);
            image = dc.getImage(21, "Places");
            placeTitle.setText(info[0]);
            placeDesc.setText(info[1]);
            placeImg.setImage(image);
            ...
            info = dc.getPlaceInfo(22);
            image = dc.getImage(22, "Places");
            placeTitle.setText(info[0]);
            placeDesc.setText(info[1]);
            placeImg.setImage(image);
            ...
            info = dc.getPlaceInfo(23);
            image = dc.getImage(23, "Places");
            placeTitle.setText(info[0]);
            placeDesc.setText(info[1]);
            placeImg.setImage(image);
            ...
            info = dc.getPlaceInfo(24);
            image = dc.getImage(24, "Places");
            placeTitle.setText(info[0]);
            placeDesc.setText(info[1]);
            placeImg.setImage(image);
        }
