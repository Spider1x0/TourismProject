 ...
 * @author fefoss454
 */
public class HotelsCityOneController implements Initializable {
    ...
    private void showPlaceInfo(ActionEvent event) throws SQLException {
        ...
        if (event.getTarget().equals(placeOneInfo)) {
            ...
            info = dc.getPlaceInfo(31);
            image = dc.getImage(31, "Places");
            ...
            info = dc.getPlaceInfo(32);
            image = dc.getImage(32, "Places");
            placeTitle.setText(info[0]);
            placeDesc.setText(info[1]);
            placeImg.setImage(image);
            ...
            info = dc.getPlaceInfo(33);
            image = dc.getImage(33, "Places");
            placeTitle.setText(info[0]);
            placeDesc.setText(info[1]);
            placeImg.setImage(image);
            ...
            info = dc.getPlaceInfo(34);
            image = dc.getImage(34, "Places");
            placeTitle.setText(info[0]);
            placeDesc.setText(info[1]);
            placeImg.setImage(image);
            ...
            info = dc.getPlaceInfo(35);
            image = dc.getImage(35, "Places");
            placeTitle.setText(info[0]);
            placeDesc.setText(info[1]);
            placeImg.setImage(image);
            ...
            info = dc.getPlaceInfo(36);
            image = dc.getImage(36, "Places");
            placeTitle.setText(info[0]);
            placeDesc.setText(info[1]);
            placeImg.setImage(image);
        }
